...
def init():
    """Initialize CODESYS connection once at startup. No-op in offline mode or if already connected."""
    global codesys_client
    if OFFLINE or not CODESYS_AVAILABLE or codesys_client is not None:
        return
    try:
